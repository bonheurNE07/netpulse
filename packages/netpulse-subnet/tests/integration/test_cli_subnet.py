...
def test_cli_subnet_info_success():
    ...
    result = runner.invoke(app, ["info", "192.168.1.50/24"])
...
def test_cli_subnet_info_invalid():
    ...
    result = runner.invoke(app, ["info", "192.168.1.50/99"])
...
def test_cli_subnet_split_success():
    ...
    result = runner.invoke(app, ["split", "192.168.1.0/24", "--subnets", "4"])
...
def test_cli_subnet_split_missing_options():
    ...
    result = runner.invoke(app, ["split", "192.168.1.0/24"])
...
def test_cli_subnet_vlsm_success():
    ...
    result = runner.invoke(app, ["vlsm", "192.168.1.0/24", "--req", "HR=120,Dev=50"])
...
def test_cli_subnet_vlsm_invalid_format():
    ...
    result = runner.invoke(app, ["vlsm", "192.168.1.0/24", "--req", "HR=invalid_host_count"])
